...
* [Vitess](#vitess)
  ...
  * [Security Enhancements](#security-enhancements-for-vitess)
* [WasmEdge](#wasmedge)
...
##### Security Enhancements for Vitess

- Description: CNCF maintains a website that checks for various compliance things. One of the sections is Security. Vitess scores quite poorly on this because we are missing quite a few things in their list. You can see the current scorecards at https://clomonitor.io/projects/cncf/vitess. We would like to improve the score on the Security section, and improve our security posture along the way.

- Expected Outcome: Complete implementation of
  - Dependency policy
  - Software Bill of Materials (SBOM)
  - Security insights
  - Signed releases

- Recommended Skills: GitHub Actions, Docker, ability to learn quickly, written communication skills. Familiarity with SBOM and or SPDX is a plus
- Expected project size: medium
- Mentor(s):
  - Deepthi Sigireddi (@deepthi, deepthi@planetscale.com)
  - Rohit Nayak (@rohit-nayak-ps, rohit@planetscale.com)
- Upstream Issue: https://github.com/vitessio/vitess/issues/17774
